...
raw_egg_pre = load('C:\Users\sanke\Downloads\NIMHANS_EGG_Workshop\HC3_pre lunch_EGG.mat');
raw_egg_post = load('C:\Users\sanke\Downloads\NIMHANS_EGG_Workshop\HC4_post_lunch_EGG.mat');
...
dom_power = max(psd_pre);
dom_freq = freq(find(psd_pre == dom_power));
...
electrodes = [8,7,4]; %electrodes' order
fs_egg = 10; %Hz
